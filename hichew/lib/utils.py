...
def get_noisy_stripes(matrices, ch, resolution, label='3-4h', percentile=99.9, method='insulation'):
    """
...
def produce_boundaries_segmentation(clr, window, ch, k=3, bsg=.0):
    """
